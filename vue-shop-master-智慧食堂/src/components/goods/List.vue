				...
				<el-table-column label="操作" width="130px">
					<template slot-scope="scope">
						...
						<el-tooltip :enterable="false" class="item" content="修改商品" effect="dark" placement="top">
							<el-button icon="el-icon-edit" size="mini" type="primary" @click="editGoodsById(scope.row.goods_id)"></el-button>
						</el-tooltip>

						<!-- 删除按钮-->
						<el-tooltip :enterable="false" class="item" content="删除商品" effect="dark" placement="top">
							<el-button icon="el-icon-delete" size="mini" type="danger" @click="removeGoodsById(scope.row.goods_id)"></el-button>
						</el-tooltip>
